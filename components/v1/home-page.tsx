...
export default function KortexHomeV10() {
  return <main className="kx10">
    <header className="site-header">
      <a className="brand" href="/"><span className="brand-mark"><i/><i/><i/></span>KORTEX</a>
    ...
    <section className="hero" id="top">
      ...
      <div className="system-map" aria-label="Kortex connects field, office, compliance and billing">
        ...
        <div className="map-core"><span className="brand-mark dark"><i/><i/><i/></span><strong>YOUR<br/>OPERATION</strong><small>CONNECTED</small></div>
    ...
    <footer className="site-footer">
      <div className="footer-brand"><a className="brand" href="/"><span className="brand-mark"><i/><i/><i/></span>KORTEX</a><p>Operational systems for MEP and construction companies.</p></div>
